...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDhEuzRypAQIK2FaN3Kbq8lp_C5nIi6SOE'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $draggableCursor			= TRUE;						// The name or url of the cursor to display on a draggable object
	var $draggingCursor				= TRUE;						// The name or url of the cursor to display when an object is being dragged
